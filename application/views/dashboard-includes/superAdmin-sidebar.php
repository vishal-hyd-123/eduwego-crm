            ...
            <div class="nav-border b-primary" data-nav="">
               ...
               <ul class="nav bg" id="accordion">
                  ...
                  <li>
                     ...
                     <a href="<?php echo base_url(); ?>admin/dashboard" class="i-con-h-a _cmmnsdHvr_ instituteActive">
                  ...
                  <li>
                     ...
                     <a href="<?php echo base_url(); ?>admin/admin_list" class="i-con-h-a _cmmnsdHvr_ instituteActive">
                     ...
                     <span class="nav-text _fntwss_ _blckClr_ nwFntSt _sdf_">Admin List</span>
                  ...
                  <li>
                     <a href="<?php echo base_url(); ?>admin/demoRequests" class="i-con-h-a _cmmnsdHvr_ addinstituteActive">
                     <span class="nav-icon">
                       <i class="i-con i-con-users _fntwss_ _blckClr_ nwFntSt _sdf_"><i></i></i>
                     </span>
                     <span class="nav-text _fntwss_ _blckClr_ nwFntSt _sdf_">Demo Requests</span>
                     </a>
                  </li>
                  <li>
                     <a href="<?php echo base_url(); ?>admin/job_post" class="i-con-h-a _cmmnsdHvr_ viewActive">
                     <span class="nav-icon">
                       <i class="fa fa-archive _fntwss_ _blckClr_ nwFntSt _sdf_"><i></i></i>
                     </span>
                     <span class="nav-text _fntwss_ _blckClr_ nwFntSt _sdf_">Job Post</span>
                     </a>
                  </li>
                  <!-- <li>
