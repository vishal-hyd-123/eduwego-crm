    ...
    <div class="title-header">
      ...
      <div class="">
        ...
        <span>
          ...
          <h3 class="mb-0 pull-left" style="color:white"><i class="fa fa-user"></i> ASSOCIATE PROFILE</h3>
        ...
        <div class="padding">
            ...
            <div class="page-title p-b-40 m-b-20 pt20">
              ...
              <span class="item-except mrm5 displayBlck _wtClr_ _fs14_ text-" style="float: right;">
                ...
                <a href="tel:<?php echo "+91 ".$profile[0]->agent_mobile; ?>" class="btn btn-success i-con-h-a call-btn"><i class="fa fa-phone"></i> Call</a>

                

                <a target="_blank" href="https://wa.me/<?=$profile[0]->agent_mobile; ?>" class="btn btn-success i-con-h-a call-btn"><i class="fa fa-whatsapp"></i> Whatsapp</a>
            ...
            <div class="row profile-box shadow-lg" style="padding:20px;background:white">
                ...
                <div class="col-md-3">
                    ...
                    <div style="width:100%">
                        ...
                        <p>
                            <?php
                                echo "<i class='fa fa-envelope'></i> ".$profile[0]->agent_email;
                            ?>
                        </p>
                ...
                <center><h4 class="mb-4">Account Details</h4></center>

                 <table class="details_table w-100 table-bordered">

                   <tr>

                     <td>Name of Associate : </td>
                   ...
                   <tr>
                     ...
                     <td>
                       ...
                       <?php
                        ...
                        foreach($received_amounts as $received_amount)

                        {

                          $total_received += $received_amount->amount;
                ...
                <div class="content-div">
                 ...
                 <center><h4 class="mb-4">Course wise Students</h4></center>
                 ...
                 <div class="kyc_image_box content-div mb-4">

                    <center><h4 class="mb-4">KYC DETAILS</h4></center>
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6" style="">
                            ...
                            <form id="front_id_form" method="post" action="<?php echo base_url(); ?>institute/upload_id_front" enctype="multipart/form-data">

                                <button type="button" class="btn btn-success view_kyc_btn" img_path="<?php echo base_url();?>uploads/<?php echo $profile[0]->id_front; ?>"><i class="fa fa-eye"></i> </button>

                                <input type="file" hidden="" name="id_front_image" id="id_front_upload" />

                                <input type="hidden" name="agent_id" value="<?php echo $profile[0]->agent_id; ?>" />

                                <button type="button" class="btn btn-primary my-3 " id="front_upload_btn">UPLOAD FRONT SIDE PHOTO</button>
                         ...
                         <div class="col-md-6">
                            ...
                            <center>
                             ...
                             <form id="back_id_form" method="post" action="<?php echo base_url(); ?>institute/upload_id_back" enctype="multipart/form-data">

                                <button class="btn btn-success view_kyc_btn" img_path="<?php echo base_url();?>uploads/<?php echo $profile[0]->id_back; ?>"><i class="fa fa-eye"></i></button>

                                <input type="file" hidden="" name="id_back_image" id="id_back_upload" />

                                <input type="hidden" name="agent_id" value="<?php echo $profile[0]->agent_id; ?>" />

                                <button type="button" class="btn btn-primary my-3" id="back_upload_btn">UPLOAD BACK SIDE PHOTO</button>
                ...
                <div class="content-div">
                    ...
                    <center><h4 class="mb-4">Address</h4></center>

                    <span><?php echo $profile[0]->agent_address; ?></span>
