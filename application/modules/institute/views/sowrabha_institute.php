							...
							<div class="col-12">
								...
								<table class="table table-bordered srored-table" width="100%;">
									...
									<tr>
										...
										<td class="padding-10" width="40%"><input type="text" name="sub1" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="score1" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="perc1" class="scored_input form-control"></td>

									</tr>

									<tr>

										<td class="padding-10" width="40%"><input type="text" name="sub2" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="score2" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="perc2" class="scored_input form-control"></td>

									</tr>

									<tr>

										<td class="padding-10" width="40%"><input type="text" name="sub3" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="score3" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="perc3" class="scored_input form-control"></td>

									</tr>

									<tr>

										<td class="padding-10" width="40%"><input type="text" name="sub4" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="score4" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="perc4" class="scored_input form-control"></td>

									</tr>

									<tr>

										<td class="padding-10" width="40%"><input type="text" name="sub5" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="score5" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="perc5" class="scored_input form-control"></td>

									</tr>

									<tr>

										<td class="padding-10" width="40%"><input type="text" name="sub6" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="score6" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="perc6" class="scored_input form-control"></td>
									...
									<tr>
										...
										<td class="padding-10" width="30%"><input type="text" name="Tscore" class="scored_input form-control"></td>

										<td class="padding-10" width="30%"><input type="text" name="Pscore" class="scored_input form-control"></td>
