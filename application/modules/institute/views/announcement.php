    ...
    <div class="page-container" id="page-container">
        <div class="padding">
            <div class="page-title p-b-40 m-b-20 pt20">
                <h2 class="mb-0 nwFntSt _blckClr_ _fwg500_ _fs16_ pull-left">Announcement</h2>
                <span class="item-except mrm5 displayBlck _wtClr_ _fs14_ text-" style="float: right;"><button onclick="openAddPopup(this, '#opnpopup')" class="btn _fs14_ _bgbrwn_ i-con-h-a edit-bttn">+ Add Announcement</button><button style="display: none;" class="btn _fs14_ _bggrn_ i-con-h-a Delete-bttn" onclick="deleteFunc()" id="multiDelete"><i class="i-con i-con-trash"><i></i></i></button></span>
            </div>
            <div class="table-responsive">
                <table id="myTable" class="table table-theme table-row v-middle responsive dataTable no-footer" role="grid" aria-describedby="clientTable_info">
                    ...
                    <thead>
                        ...
                        <th><span class="text-muted _blckClr_ _fs14_ _fwg500_ nwFntSt">#Announcement Name</span></th>
                    ...
                    <tbody id="tableBody">
                        ...
                        <?php
                        $enq = $this->institute_model->get_all_announcment();
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 popup_bg_color padding-16">
                    ...
                    <form id="multiPleDeleteqw" method="POST" action="<?php echo base_url(); ?>institute/delete_announcment">
                        <div class="row">
