...
<html>
<head>
	<title>Paperless Live Application Form - Oxford Group Of Institutions</title>
	<meta name="description" content="Online admission application form for Oxford Group Of Institutions Bengaluru" />
	...
	<form id="admisn-form" method="POST" action="<?php echo base_url();?>institute/admissionDetails/<?php echo $this->uri->segment(2); ?>" enctype="multipart/form-data">
		<div class="row">
			<div class="col-12 col-md-3 text-center">
				<div class="">
					<img class="nextynFavLogo_" src="<?php echo base_url(); ?>assets/dashboard/img/oxford_logo.png" style="width:220px">
				</div>
			</div>
			<div class="col-12 col-md-9 clg-heading">
				
				<center><h2 class="oxford_text_clr fw-600">Oxford Group of Institutions<h2></center>
			    
				<div class="row">
					<div class="col-md-9">
						<center><p class="institute_addss_p">Bettahalsoor Cross, International Airport Road, B.B Road, Bangalore -562157</p></center>

						<div class="col-12 col-md-12">
							<div class="checkbox_for_corse_dv">
								<ul class="checkbox_for_corse_ul oxford_course_ul">
									<li>
									...
									<li>
				                        ...
				                        <label class="m-l-30 fs-18 _blckClr_">P.B.B.Sc. Nursing</label>
									</li>
									<li>
										<label class="checkbox_enquiry m-t-10">
									...
									<li>
										<label class="checkbox_enquiry m-t-10">
				                        <input type="radio" name="course_applied_for" value="Paramedical Courses" class="pivileges singleInput">
				                        <span class="checkmark_enquiry"></span>
				                        </label>
				                        <label class="m-l-30 fs-18 _blckClr_">Paramedical Courses</label>
									</li>
									<li>
										<label class="checkbox_enquiry m-t-10">
				                        <input type="radio" name="course_applied_for" value="Diploma Pharmacy" class="pivileges singleInput">
				                        <span class="checkmark_enquiry"></span>
				                        </label>
				                        <label class="m-l-30 fs-18 _blckClr_">Diploma Pharmacy</label>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row justify-content-center">
						...
						<div class="col-12 text-center">
							<div class="m-t-25">
								...
								<input type="text" name="admisn_number" class="admisn_numb_inpt" disabled="disabled"><br/>
							...
							<div class="padding-20">
								<div class="row">
									...
									<div class="col-12 col-md-9">
					                    ...
					                    <div class="dis-inline-block">
					                        <label class="checkbox_enquiry m-t-10">
					                        <input type="radio" name="sex" value="GNM" class="pivileges singleInput">
					                        <span class="checkmark_enquiry"></span>
					                        </label>
							...
							<div class="row">
								<div class="col-12 academic-details">
									<table class="table table-bordered srored-table" width="100%;">
										<tr>
											<td colspan="3">
												<span>Name of University / Board:<input type="text" name="board_name" class="scored_input form-control"></span>
											</td>
										</tr>
										<tr>
											<td colspan="3">
												<span>Name of College / School:<input type="text" name="school_name_twelth" class="scored_input form-control"></span>
											</td>
										</tr>
