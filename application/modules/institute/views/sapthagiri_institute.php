...
<head>
	...
	<title>Paperless Live Application Form - SAPTHAGIRI SCHOOL OF NURSING</title>

	<meta name="description" content="Online admission application form for SAPTHAGIRI SCHOOL OF NURSING Bengaluru" />
	...
	<div class="container p-t-30 p-b-20">
		...
		<div class="row">
			...
			<div class="col-12 col-md-10 text-center">
				...
				<h2 class="text-danger">SAPTHAGIRI SCHOOL OF NURSING</h2>

				<h2 class="text-danger">SRI KRISHNA COLLEGE OF NURSING</h2>

				<h2 class="text-danger">SRI RAGHAVENDRA COLLEGE OF NURSING</h2>
						...
						<div class="padding-20">
							...
							<div class="row">
								...
								<div class="col-12 col-md-3">
									...
									<input type="text" name="student_mobile_number" class="student_mon_inpt" maxlength="10">
								...
								<div class="col-12 col-md-3">
									...
									<input id="father_mo_number" type="text" name="father_mo_number" class="student_mon_inpt" maxlength="10" required autocomplete="new">
						...
						<div class="padding-20">
							...
							<div class="row">
								...
								<div class="col-12 col-md-3">
									...
									<input  type="text" name="nationality_citizen" class="student_mon_inpt" maxlength="16" autocomplete="new">
						...
						<div class="padding-20">
							...
							<div class="row m-t-16">
								...
								<div class="col-12 col-md-3">
									...
									<input type="text" name="income_all" class="student_mon_inpt" autocomplete="new">
