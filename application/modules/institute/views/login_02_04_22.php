          ...
          <div id="LogIn-Inner" class="row justify-content-center">
            <div class="col-12 col-lg-6 mobile_view_img">
              <div class="loginimgDiv"style="position: relative;"> 
                <img class="imgRad" src="<?php echo base_url(); ?>assets/dashboard/img/loginimg.png" style="width:100%;height:100%">
              </div>
            ...
            <div class="col-12 col-lg-6">
              <div class="Login_Ryt">
                <form id="instituteLogin" method="POST" action="<?php echo base_url('institute/instituteLogin'); ?>">
