...
<html>
<head>
	<title>Paperless Live Application Form - MNG Group Of Institutions</title>
	<meta name="description" content="Online admission application form for MNG Group Of Institutions Bengalore" />
		...
		<div class="row">
			<div class="col-12 col-md-2 text-center">
				<div class="logo_main_">
					<img class="nextynFavLogo_" src="<?php echo base_url(); ?>assets/dashboard/img/mng_logo.png">
				</div>
			</div>
			<div class="col-12 col-md-10 mb-3 text-center">
				
				<h3 class="fs-42 mng-color fw-600">M.N.G. GROUP OF INSTITUTION</h3>
			    <span class="mng-reg">Recognized by Govt. of Karnataka, Affiliated to RGUHS & K.S.N.C. Karnataka Recognized by Indian Nursing Council, New Delhi</span>
				<div class="row my-4">
					<div class="col-sm-12 col-md-9">
						<div class="contact_Main_Div text-center">
							<p class="institute_addss_p"># 98, 5th Block, SMV Railway Layout, <br/>Kodigehalli Kenchanapura, Bengaluru - 560 091.</p>
						</div>
					</div>
				...
				<div class="col-12">
					...
					<div class="row justify-content-center">
						<div class="col-12 col-md-12">
							<div class="course-heading-mng mng-bg-clr">
								<h3 class="text-white">Course Apply For</h3>
							</div>
							<div class="checkbox_for_corse_dv">
								...
								<ul class="checkbox_for_corse_ul">
									...
									<li>
										<label class="checkbox_enquiry m-t-10">
				                        <input type="radio" name="course_applied_for" value="M.Sc. Nursing" class="pivileges singleInput">
				                        <span class="checkmark_enquiry"></span>
				                        </label>
				                        <label class="m-l-30 fs-18 _blckClr_">M.Sc. Nursing</label>
									</li>
									<li>
										<label class="checkbox_enquiry m-t-10">
									...
									<li>
										<label class="checkbox_enquiry m-t-10">
				                        <input type="radio" name="course_applied_for" value="B.Sc. Allied Science" class="pivileges singleInput">
				                        <span class="checkmark_enquiry"></span>
				                        </label>
				                        <label class="m-l-30 fs-18 _blckClr_">B.Sc. Allied Science</label>
									</li>
									<li>
										<label class="checkbox_enquiry m-t-10">
				                        <input type="radio" name="course_applied_for" value="BPT" class="pivileges singleInput">
				                        <span class="checkmark_enquiry"></span>
				                        </label>
				                        <label class="m-l-30 fs-18 _blckClr_">BPT</label>
									</li>
								</ul>
						...
						<div class="col-12">
							<div class="m-t-25 appli_form_main">
								<h3 class="fs-30 mng-color fw-600">Application Form</h3>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="border_of_form">
							...
							<div class="padding-20">
								<div class="row">
									<div class="col-12">
										...
										<input  type="text" name="year_of_passing" class="w-full student_mon_inpt form-control" required autocomplete="new">
									</div>
								</div>
							</div>
							<hr class="hr_class">
							<div class="padding-20">
								<div class="row">
									...
									<div class="col-12 col-md-3">
										...
										<input type="text" name="extra_exam_total1" class="scored_input form-control">
									</div>
									<div class="col-12 col-md-3">
										<label class="fs-14 fw-600 _blckClr_">Marks Secured</label><br/>
										<input type="text" name="extra_exam_mark1" class="scored_input form-control">
									</div>
									<div class="col-12 col-md-3">
										<label class="fs-14 fw-600 _blckClr_">Percentage</label><br/>
										<input type="text" name="extra_exam_perc1" class="scored_input form-control">
									</div>
								</div>
							</div>
							<hr class="hr_class">
							<div class="padding-20">
								<div class="row">
									...
									<div class="col-12 col-md-3">
										<input  type="text" name="nationality_citizen" class="student_mon_inpt form-control" maxlength="16" autocomplete="new">
									</div>
								</div>
							</div>
							<hr class="hr_class">
							<div class="padding-20">
								...
								<div class="row m-t-16">
									...
									<div class="col-12 col-md-3">
										<input type="text" name="income_all" class="student_mon_inpt form-control" autocomplete="new">
									</div>
								</div>
							</div>
							<hr class="hr_class">
							<div class="row m-t-30">
								<div class="col-12 text-center">
									<div class="padding-20 mng-bg-clr">
							...
							<div class="row">
								<div class="col-12">
									<table class="table table-bordered srored-table academic" width="100%;">
										<tr>
											<td colspan="3">
												<span style="font-size:15px">Name of University / Board:<input type="text" name="board_name" class="scored_input form-control"></span>
											</td>
										</tr>
										<tr>
											<td colspan="3">
												<span style="font-size:15px">Name of College / School:<input type="text" name="school_name_twelth" class="scored_input form-control"></span>
											</td>
										</tr>
										<tr class="text-center">
											<th colspan="3" class="padding-10 mng-bg-clr">Marks Scored in Last Qualifying Examination</th>
										</tr>
										<tr class="text-center">
										...
										<tr>
											<td class="padding-10 text-center" width="40%"><input type="text" name="sub1" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="score1" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="perc1" class="scored_input"></td>
										</tr>
										<tr>
											<td class="padding-10 text-center" width="40%"><input type="text" name="sub2" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="score2" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="perc2" class="scored_input"></td>
										</tr>
										<tr>
											<td class="padding-10 text-center" width="40%"><input type="text" name="sub3" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="score3" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="perc3" class="scored_input"></td>
										</tr>
										<tr>
											<td class="padding-10 text-center" width="40%"><input type="text" name="sub4" class="scored_input "></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="score4" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="perc4" class="scored_input"></td>
										</tr>
										<tr>
											<td class="padding-10 text-center" width="40%"><input type="text" name="sub5" class="scored_input "></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="score5" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="perc5" class="scored_input"></td>
										</tr>
										<tr>
											<td class="padding-10 text-center" width="40%"><input type="text" name="sub6" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="score6" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="perc6" class="scored_input"></td>
										</tr>
										<tr>
											<td align="right" class="padding-10 text-center" width="40%"><span class="m-l-30">Total</span></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="Tscore" class="scored_input"></td>
											<td class="padding-10 text-center" width="30%"><input type="text" name="Pscore" class="scored_input"></td>
										</tr>
										<!-- <tr class="border">
								...
								<div class="row">
									<div class="col-12 col-md-4">
										<div>
											...
											<input type="text" name="submission_date" class="examDate form-control"  data-toggle="datepicker">
										</div>
										<div>
											<label class="fs-14 _blckClr_">Place:</label>
											<input type="text" name="submission_place" class="form-control">
										</div>
									</div>
									<div class="col-12 col-md-4">
									...
									<div class="row mt-3">
										<div class="col-md-4">
											<label class="fs-14 _blckClr_">Admission Partner Code (Not Applicable for direct admission)</label>
								...
								<div class="row justify-content-center m-t-30">
					              ...
					              <div class="col-12 col-md-6 btn_position">
					                ...
					                <span class="loadingMyprofile" style="top: 2px; right: -3%"><img src="<?php echo base_url(); ?>assets/dashboard/img/loading7.gif"></span>
					                 <button type="submit" class="savebtn mng-bg-clr btn">Save</button>
					              </div>
					           </div>
					        </div>
						</div>
