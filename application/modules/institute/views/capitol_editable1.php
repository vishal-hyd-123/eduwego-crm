...
<div class="page_bg_clr p-b-40">
	...
	<!-- Header section End-->
	 <form method="POST" action="<?php echo base_url()."institute/"?>editonlineenquiry"  enctype="multipart/form-data">
	 	<input type="hidden" name="online_enquiry_id"  value="{online_enquiry_id}">
		...
		<!-- form upper section -->
			<div class="row">
				...
				<div class="col-12 col-sm-4 col-lg-5">
					...
					<input type="text" name="admisn_number" class="admisn_numb" disabled="disabled" value="{_admisn_number_}">
				...
				<div class="col-12 col-sm-4 col-lg-4">
					...
					<input type="text" name="serial_number" class="make_Reqin" disabled="disabled" value="{serial_number}">
				</div>
				<div class=" col-12 col-sm-4 col-lg-3 position_relative">
					<label class="passport_img_main" for="profileImage">
						<img src="<?php echo base_url();?>uploads/{profileImage}" id="profileImg" >
						<input type="file" name="profileImage" onchange="getProfileImage(this)" id="profileImage" hidden  value="{profileImage}">
						<p id="getText" hidden="hidden">Affix your Passport size photograph here</p>
					</label>
				</div>
			</div>
				...
				<div class="col-12 padding">
	                <div class="form-group row">
	                  ...
	                  <div class="col-12 col-sm-4">
	                     ...
	                     <input id="dob" type="text" name="dob" class="form-control makeReqin" required autocomplete="new" value="{dob}">
	                  </div>
	                </div>
	                <div class="form-group row">
	                  <div class="col-12 col-sm-8">
	                     <label for="" class="col-form-label _fs14_ _fwg500_ _greyClr_ text-left">Father Name*</label>
	                     <input id="father_name" type="text" name="father_name" class="form-control makeReqin" required autocomplete="new" value="{father_name}">
	                  </div>
	                  <div class="col-12 col-sm-4">
	                     <label for="" class="col-form-label _fs14_ _fwg500_ _greyClr_ text-left">Father Number*</label>
	                     <input id="father_mo_number" type="text" name="father_mo_number" class="form-control makeReqin" required autocomplete="new" value="{father_mo_number}">
	                  </div>
	                </div>
	                <div class="form-group row">
	                  <div class="col-12 col-sm-8">
	                     <label for="" class="col-form-label _fs14_ _fwg500_ _greyClr_ text-left">Mothers Name*</label>
	                     <input id="mothersname" type="text" name="mothersname" class="form-control makeReqin" required autocomplete="new" value="{mothersname}">
	                  </div>
	                  <div class="col-12 col-sm-4">
	                     <label for="" class="col-form-label _fs14_ _fwg500_ _greyClr_ text-left">Mobile Number*</label>
	                     <input id="mother_mo_number" type="text" name="mother_mo_number" class="form-control makeReqin" required autocomplete="new" value="{mother_mo_number}">
	                  </div>
	                </div>
	                <div class="form-group row">
	                  <div class="col-12 col-sm-4">
	                     <label for="" class="col-form-label _fs14_ _fwg500_ _greyClr_ text-left">Natianality*</label>
	                     <input id="mothersname" type="text" name="natianality" class="form-control makeReqin" required autocomplete="new" value="{natianality}">
	                  </div>
	                  <div class="col-12 col-sm-4">
	                     <label for="" class="col-form-label _fs14_ _fwg500_ _greyClr_ text-left">Caste*</label>
	                     <input id="mother_mo_number" type="text" name="caste" class="form-control makeReqin" required autocomplete="new" value="{caste}">
	                  </div>
	                  <div class="col-12 col-sm-4">
	                ...
	                <div class="form-group row">
	                	<div class="col-12">
	                		...
	                		<input id="nationality_citizen_number" type="text" name="nationality_citizen" class="form-control makeReqin" required autocomplete="new" value="{nationality_citizen}">
	                	</div>
	                </div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-12 col-sm-6">
								 <div class="">
			                        ...
			                        <label class="m-l-30 fs-14 _blckClr_">{course_applied_for}</label>
								 </div>
								 <div class="">
								 	<label class="checkbox_enquiry">
				...
				<div class="col-sm-4">
					<div class="p-t-30">
						<table class="table table-bordered srored_table" width="100%;">
							...
							<tr>
								<td class="padding-10" width="50%"><input type="text" name="sub1" class="scored_input" value="{sub1}"></td>
								<td class="padding-10" width="50%"><input type="text" name="score1" class="scored_input" value="{score1}"></td>
							</tr>
							<tr>
								<td class="padding-10" width="50%"><input type="text" name="sub2" class="scored_input" value="{sub2}"></td>
								<td class="padding-10" width="50%"><input type="text" name="score2" class="scored_input" value="{score2}"></td>
							</tr>
							<tr>
								<td class="padding-10" width="50%"><input type="text" name="sub3" class="scored_input" value="{sub3}"></td>
								<td class="padding-10" width="50%"><input type="text" name="score3" class="scored_input" value="{score3}"></td>
							</tr>
							<tr>
								<td class="padding-10" width="50%"><input type="text" name="sub4" class="scored_input" value="{sub4}"></td>
								<td class="padding-10" width="50%"><input type="text" name="score4" class="scored_input" value="{score4}"></td>
							</tr>
							<tr>
								<td class="padding-10" width="50%"><input type="text" name="sub5" class="scored_input" value="{sub5}"></td>
				...
				<div class="col-12 col-sm-4 col-lg-4">
					<div class="p-t-30">
						<div class="m-b-15">
							...
							<input type="text" name="last_exam_pass" class="scored_detail_input" value="{last_exam_pass}">
						</div>
						<div class="m-b-15">
							<label class="fs-14 _blckClr_">Board Name</label>
							<input type="text" name="board_name" class="scored_detail_input" value="{board_name}">
						</div>
						<div class="m-b-15">
							<label class="fs-14 _blckClr_">Year of Passing</label>
							<input type="text" name="year_of_passing" class="scored_detail_input" value="{year_of_passing}">
						</div>
						<div class="m-b-15">
							<label class="fs-14 _blckClr_">Registration No.</label>
							<input type="text" name="registration_no" class="scored_detail_input" value="{registration_no}">
						</div>
						<div class="m-b-15">
							<label class="fs-14 _blckClr_">10+2 School Name</label>
							<input type="text" name="school_name_twelth" class="scored_detail_input" value="{school_name_twelth}">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12 col-sm-6">
						...
						<div>
							...
							<input type="text" name="student_mobile_number" class="student_input" value="{student_mobile_number}">
						</div>
					</div>
					<div class="col-12 col-sm-6">
						<div class="m-b-12 m-t-768">
							<label class="fs-14 _blckClr_">Local Guardian Address</label>
							<textarea class="local_address" name="localaddress">{localaddress}</textarea>
						</div>
						<div class="m-b-15">
							<label class="fs-14 _blckClr_">Relation with Student</label>
							<input type="text" name="relation_with_student" class="student_input" value="{relation_with_student}">
						</div>
						<div class="m-b-15">
							<label class="fs-14 _blckClr_">Mobile Number</label>
							<input type="text" name="mob_number" class="student_input" value="{mob_number}">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-12 col-sm-4">
						<div style="position: relative;">
							<label class="signatureDiv" for="imgInp">
								...
								<input type="file" name="father_sign" hidden="" onchange="readURLFirst(this);" id="imgInp"  value="{father_sign}">
								<div class="_df4df_">
					...
					<div class="col-12 col-sm-4">
						<div style="position: relative;">
							<label class="signatureDiv" for="imgInp1">
								...
								<input type="file" hidden="" name="student_sign" onchange="readURLSecnd(this);" id="imgInp1"   value="{student_sign}">
								<div class="_df4df_">
				...
				<div class="col-12 col-sm-4">
					<div class="office_section">
						...
						<div class="m-t-30">
							...
							<input type="text" name="admitted_by" class="form_input_ofc" autocomplete="off" value="{admitted_by}">
						</div>
						<div>
							<label class="fs-14 _blckClr_">Mobile Number:</label>
							<input type="text" name="admitted_by_number" class="form_input_ofc" value="{admitted_by_number}">
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-4">
					<div class="office_section">
						...
						<div class="m-t-30">
							<label class="fs-14 _blckClr_">Name:</label>
							<input type="text" name="varified_by" class="form_input_ofc" autocomplete="off" value="{varified_by}">
						</div>
					</div>
				</div>
				<div  class="col-12 col-sm-4">
					<div class="office_section">
						...
						<div class="m-t-30">
							<label class="fs-14 _blckClr_">Name:</label>
							<input type="text" name="entered_by" class="form_input_ofc" autocomplete="off" value="{entered_by}">
						</div>
					</div>
				</div>
			</div>
