            ...
            <div class="right">
                ...
                <div class="logo-con">
                    ...
                    <form id="studentSignup" method="POST" action="<?php echo $base_url; ?>institute/studentSignup">
                        ...
                        <center>
                            <input type="number" name="otp" class="otp_Input form-control" id="otp" placeholder="Enter otp" required>
                            <input type="submit" value="Submit Now" class="login" id="submitbutton">
                            <i class="fa fa-spinner fa-spin d-none" style="font-size:24px"></i>
                      
                            <button style="width:100%;padding:5px;margin:3px 0px;" class="login" id="sendotp">Send Otp</button>
...
//   $("#sendotp").hide();
  var mob = $("#mobile").val();
  var user_name = $("input[name=student_name]").val();
          $.ajax({
            type : 'POST',
            url : '<?=base_url(); ?>institute/sendsignupotp',
            data : {
                mob : mob,
                user_name : user_name,
            },
