		...
		<div class="row">
			<div class="col-12 col-md-2 text-center">
				<div class="logo_main_">
					<img class="nextynFavLogo_" src="<?php echo base_url(); ?>assets/dashboard/img/oxford_logo.png">
				</div>
			</div>
			<div class="col-12 col-md-10 clg-heading">
				
				<h1 class="oxford_text_clr fw-600">Oxford<h1>
				<h3>Group of Institutions</h3>
						...
						<div class="col-12">
							...
							<div class="row justify-content-center">
								<div class="col-12 col-md-12">
									...
									<div class="course-heading-oxford">
							...
							<div class="padding-20">
								...
								<div class="row mt-3">
									<div class="col-md-4">
										...
										<input type="text" name="partner_code" class="form-control" value="{partner_code}">
