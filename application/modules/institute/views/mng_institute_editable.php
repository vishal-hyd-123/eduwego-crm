				...
				<div class="row my-4">
					<div class="col-md-9">
						<div class="contact_Main_Div text-center">
							<p class="institute_addss_p"># 98, 5th Block, SMV Railway Layout, Kodigehalli Kenchanapura,<br/> Bengaluru - 560 091.</p>
						</div>
					</div>

					<div class="col-12 col-md-2">
						<label class="_passport_img_main_" for="profileImage">
							<img src="<?php echo base_url(); ?>uploads/{student_photo}" id="profileImg" height="100%">
