          ...
          <div class="reports-box" style="padding:10px;height:auto">
            <h2>All Reports</h2>
              ...
              <div id="paid_course_wise" class="tabcontent">
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <select class="form-control selected_yr">
                      <?php  
                      $curr_yr = date('Y');
                      $starting_yr = '2021';
                  ...
                  <div class="col-md-4">
                    <button onclick="exportTableToExcel('report-table','paid_due')" class="btn pull-right mb-3" style="cursor:pointer"><i class="fa fa-download"></i> Excel</button>
                    <!-- <button type="button" class="btn pull-right course_wise_btn" style=""><i class="fa fa-download"></i> CSV</button> -->
                  </div>
                </div>
              ...
              <div id="paid_year_wise" class="tabcontent">
                <button onclick="exportTableToExcel('year-wise-table','year_wise_amount')" class="btn pull-right mb-3" style="cursor:pointer"><i class="fa fa-download"></i> Excel</button>
                    ...
                    <table class="table-bordered w-100" id="year-wise-table">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th style="padding:7px">Total Amount(Rs.)</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?=$year_wise_paid; ?>
              ...
              <div id="paid_student_wise" class="tabcontent">
                <button type="button" onclick="exportTableToExcel('student_paid_table','student_wise_paid')" class="btn pull-right mb-3" style="cursor:pointer"><i class="fa fa-download"></i> EXCEL</button>
                  ...
                  <div id="student_paid_table" >
                    <center><h3 class="my-3">Total Fee Paid Students Wise</h3></center>
                    <table class="table-bordered" style="width:100%">
                      <tr>
                        <th style="padding: 7px;">Year</th>
                        <td class="year" style="padding: 7px;"><?=date('Y'); ?></td>
                        <th style="padding: 7px;">Course</th>
                        <td style="padding: 7px;" class="course">-</td>
                        <th style="padding: 7px;">Stream</th>
                        <td style="padding: 7px;" class="stream">-</td>
                        <th style="padding: 7px;">Agent</th>
                        <td style="padding: 7px;" class="agent">-</td>
                      </tr>
                    </table>
                    ...
                    <table class="table-bordered w-100">
                        <thead>
                          <tr>
                            <th style="padding:7px"><span class="text-muted _blckClr_ _fs14_ _fwg500_ nwFntSt">Sl.No.</span></th>
                            <th style="padding:7px"><span class="text-muted _blckClr_ _fs14_ _fwg500_ nwFntSt">Student Name</span></th>
                            <th style="padding:7px"><span class="text-muted _blckClr_ _fs14_ _fwg500_ nwFntSt">Paid Amount</span></th>
                          </tr>
                        </thead>
              ...
              <div id="collected_date_wise" class="tabcontent">
                <button type="button" onclick="exportTableToExcel('monthly_fees_table','month_wise_payment')" class="btn pull-right mb-3" style="cursor:pointer"><i class="fa fa-download"></i> EXCEL</button>
                
                <form id="date_search_form">
...
<script>
  $("#payment-details").submit(function(e){
    ...
    $.ajax({
      type : 'POST',
      url : '<?=base_url(); ?>institute/getStudentPayments',
      data : $(this).serialize(),
      success : function(res){
        $("#studentTableBody").html(res);
      }
    });
  });
</script>
...
<script>
  $("#paid_course_wise .selected_yr").on('change',function(){
    var selected_yr = $(this).val();
    courseWiseCollection(selected_yr);
  });

  function courseWiseCollection(selected_yr)
  {
    $.ajax({
      type : 'POST',
      url : '<?=base_url(); ?>institute/courseWiseCollection',
      data : {
        selected_yr : selected_yr,
      },
      success : function(res){
        $("#report-table tbody").html(res);
      }
    });
  }
</script>
