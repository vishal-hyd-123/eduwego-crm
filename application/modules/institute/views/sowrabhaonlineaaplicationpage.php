...
<div class="page_grn_bg_clr p-b-40">
		...
		<div class="row">
			<div class="col-12 col-md-2 text-center">
				<div style="position: relative;">
					<div class="text-center" style="position: absolute;top:-45px;">
						<img style="max-width: 70%" src="<?php echo base_url(); ?>assets/dashboard/img/logoMain.png">
					</div>
				</div>
			</div>
	...
	<!-- Header section End-->
	 <form id="admisn-form" method="POST" action="<?php echo base_url(); ?>institute/submitonlineenquiry"  enctype="multipart/form-data">
		...
		<!-- form upper section -->
			<div class="row">
				...
				<div class="col-12">
					...
					<input type="text" name="admisn_number" style="width: 50%" class="admisn_numb" disabled="disabled">
				...
				<div class=" col-12 col-md-4 col-lg-3  position_relative">
				...
				<div class="col-12 padding">
	                <div class="form-group row">
	                  <div class="col-12 col-md-8">
	                     ...
	                     <input id="name" type="text" name="name" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                  <div class="col-12 col-md-4">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Dob</label>
	                     <input id="dob" type="date" name="dob" class="form-control _inputField_ dis-inline-block " required autocomplete="new">
	                  </div>
	                </div>
	                <div class="form-group row">
	                  <div class="col-12 col-md-8">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Father Name*</label>
	                     <input id="father_name" type="text" name="father_name" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                  <div class="col-12 col-md-4">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Father Number*</label>
	                     <input id="father_mo_number" type="text" name="father_mo_number" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                </div>
	                <div class="form-group row">
	                  <div class="col-12 col-md-8">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Mothers Name*</label>
	                     <input id="mothersname" type="text" name="mothersname" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                  <div class="col-12 col-md-4">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Mobile Number*</label>
	                     <input id="mother_mo_number" type="text" name="mother_mo_number" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                </div>
	                <div class="form-group row">
	                  <div class="col-12 col-md-4">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Natianality*</label>
	                     <input id="mothersname" type="text" name="natianality" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                  <div class="col-12 col-md-4">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Caste*</label>
	                     <input id="mother_mo_number" type="text" name="caste" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                  <div class="col-12 col-md-4">
	                     <label for="" class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Sex*</label>
	                     <input id="sex" type="text" name="sex" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                  </div>
	                </div>
	                <div class="form-group row">
	                	<div class="col-12">
	                		<label class=" _fs14_ _fwg500_ fnt_grn_clr text-left dis-inline-block">Nationality Citizenship No.</label>
	                		<input id="nationality_citizen_number" type="text" name="nationality_citizen" class="form-control _inputField_ dis-inline-block" required autocomplete="new">
	                	</div>
	                </div>
				</div>
			</div>
							...
							<div class="p-t-10 tbl_border_grn">
								<table class="table table-bordered srored_table" width="100%;">
									...
									<tr>
										...
										<td class="padding-10" width="50%"><input type="text" name="score6" class="scored_input"></td>
									</tr>
									<tr>
						...
						<div class="col-12 col-md-4">
							<div class="p-t-30">
								<div class="m-b-15">
									...
									<input type="text" name="last_exam_pass" class="scoredDetailIinput">
								</div>
								<div class="m-b-15">
									<label class="fs-14 fnt_grn_clr">Board Name:</label>
									<input type="text" name="board_name" class="scoredDetailIinput m-l-40">
								</div>
								<div class="m-b-15">
									<label class="fs-14 fnt_grn_clr">Year of Passing:</label>
									<input type="text" name="year_of_passing" class="scoredDetailIinput m-l-22">
								</div>
								<div class="m-b-15">
									<label class="fs-14 fnt_grn_clr">Registration No.:</label>
									<input type="text" name="registration_no" class="scoredDetailIinput m-l-20">
								</div>
								<div class="m-b-15">
									<label class="fs-14 fnt_grn_clr">Name and address of school last attended:</label>
									<input type="text" name="school_name_twelth" class="scoredDetailIinput w-full">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="permanent_add_main">
							<div class="m-b-15">
								...
								<textarea style="height: 125px;" class="addrss_textarea_inpt" name="permanent_address"></textarea>
							</div>
							<div class="">
					...
					<div class="col-12 col-md-6">
						<div class="local_add_main">
							<div class="m-b-12 m-t-768">
								...
								<textarea class="addrss_textarea_inpt" name="local_address"></textarea>
							</div>
							<div class="m-b-15 borde_bottom_input">
								<label class="fs-14 fnt_grn_clr">Relation with Student :</label>
								<input type="text" name="relation_with_student" class="student_mon_inpt">
							</div>
							<div class="m-b-15 ">
								<label class="fs-14 fnt_grn_clr">Mobile Number :</label>
								<input type="text" name="mob_number" class="student_mon_inpt">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-md-4">
					<div class="office_section office_section_">
						...
						<div class="Admited_by_text">
							...
							<input type="text" name="admitted_by" class="scoredDetailIinput" autocomplete="off" readonly>
						</div>
						<div>
							<label class="fs-14 fnt_grn_clr dis-inline-block">Mobile Number:</label>
							<input  type="text" name="mob-number" class="scoredDetailIinput dis-inline-block" readonly>
						</div>
					</div>
				</div>
				<div class="col-12 col-md-4">
					<div class="office_section office_section_">
						...
						<div class="Admited_by_text">
							<label class="fs-14 fnt_grn_clr">Name:</label>
							<input type="text" name="varified_by" class="scoredDetailIinput" autocomplete="off" readonly>
						</div>
					</div>
				</div>
				<div  class="col-12 col-md-4">
					<div class="office_section office_section_">
						...
						<div class="Admited_by_text">
							<label class="fs-14 fnt_grn_clr">Name:</label>
							<input type="text" name="entered_by" class="scoredDetailIinput" autocomplete="off" readonly>
						</div>
					</div>
				</div>
			</div>
