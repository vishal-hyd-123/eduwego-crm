                    ...
                    <tbody id="tableBody">
                        ...
                        ?>
                            <tr>
                                <td>
                                    <!-- <label class="checkboxcontainer">
                           <input type="checkbox" name="<?php echo $enq[$i]->agent_id; ?>" class="pivileges">
                           <span class="checkmark"></span>
                         </label>  -->
                                    <label class="checkboxcontainer">
                                ...
                                <td class="actionbtns">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" onclick="deleteFunc('<?php echo $enq[$i]->agent_id; ?>');" class="btn _fs14_ _bggrn_ i-con-h-a Delete-bttn staff_unable text-white"><i class="i-con i-con-trash"><i></i></i></button>
                                    </div>
                                </td>
                            </tr>
