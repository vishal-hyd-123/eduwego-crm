...
<body>
<div class="sowrabha_bg_clr p-b-40">
	<!-- Header section -->
	<div class="container p-b-20">
		<div class="row">

			<div class="col-12 col-md-2 text-center inst-logo">
				<div class="logo_main_">
					<img class="nextynFavLogo_" src="<?php echo base_url(); ?>assets/dashboard/img/logoMain.png">
				</div>
			</div>

			<div class="col-12 col-md-10 text-center inst-header">

				<h3 class="fs-42 fnt_blue_clr fw-600">SOWRABHA INSTITUTE OF NURSING SCIENCES</h3>
		...
		<div class="row">
			...
			<div class="col-12 col-md-12">
				...
				<div class="contact_Main_Div">
					...
					<p class="fs-20 fnt_grn_clr m-b-0"><span>Mob <a class="fs-20 fnt_grn_clr" href="tel: 960 6688 111 ">080-95555702 </a></span> / <span>E-mail <a class="fs-20 fnt_grn_clr" href="mailto: sincbangalore@gmail.com"> sowrabhaedu@gmail.com</a></span> / <span><a class="fs-20 fnt_grn_clr" href="http://sowrabhaedu.in/">http://sowrabhaedu.in/</a></span>
						...
						<div class="checkbox_for_corse_dv">
							<ul class="checkbox_for_corse_ul">
								...
								<li>
			                        ...
			                        <input type="radio" name="course_applied_for" value="Pharmacy" class="pivileges singleInput">

			                        <span class="checkmark_enquiry"></span>

			                        </label>

			                        <label class="m-l-30 fs-18 _blckClr_">Pharmacy</label>
								...
								<li>
			                        ...
			                        <input type="radio" name="course_applied_for" value="Paramedical" class="pivileges singleInput">

			                        <span class="checkmark_enquiry"></span>

			                        </label>

			                        <label class="m-l-30 fs-18 _blckClr_">Paramedical</label>
					...
					<div class="border_of_form">
						...
						<div class="padding-20">
							<div class="row">
								...
								<div class="col-12 col-md-3">
									 <input id="nationality_citizen_number" type="text" name="natianality" class="student_mon_inpt form-control" required autocomplete="new" value="{natianality}">
								</div>
								<div class="col-12 col-md-3">
									<label for="" class="col-form-label _fs14_ fw-600 _blckClr_ text-left">Aadhar No. :</label>
								</div>
								<div class="col-12 col-md-3">
									<input  type="text" name="nationality_citizen" class="student_mon_inpt form-control" required autocomplete="new" value="{nationality_citizen}">
								</div>
							</div>
						</div>
						<hr class="hr_class">
						<div class="padding-20">
							<div class="row">
								...
								<div class="col-12 col-md-3">
									<input type="text" name="father_Profession" class="student_mon_inpt form-control" value="{father_Profession}">
								</div>
							</div>
							<div class="row m-t-16">
								...
								<div class="col-12 col-md-3">
									<input type="text" name="income_all" class="student_mon_inpt form-control" required autocomplete="new" value="{annual_income}">
								</div>
							</div>
						</div>
						<hr class="hr_class">
						...
						<div class="row">
							<div class="col-12">
								<table class="table table-bordered srored-table" width="100%;">
									<tr>
										<td colspan="3">
											<span>Name of University / Board:<input type="text" name="board_name" class="scored_input form-control" value="{board_name}"></span>
										</td>
									</tr>
									<tr>
										<td colspan="3">
									...
									<tr>
										<td class="padding-10" width="40%"><input type="text" name="sub1" class="scored_input form-control" value="{sub1}"></td>
										<td class="padding-10" width="30%"><input type="text" name="score1" class="scored_input form-control" value="{score1}"></td>
										<td class="padding-10" width="30%"><input type="text" name="perc1" class="scored_input form-control" value="{perc1}"></td>
									</tr>
									<tr>
										<td class="padding-10" width="40%"><input type="text" name="sub2" class="scored_input form-control" value="{sub2}"></td>
										<td class="padding-10" width="30%"><input type="text" name="score2" class="scored_input form-control" value="{score2}"></td>
										<td class="padding-10" width="30%"><input type="text" name="perc2" class="scored_input form-control" value="{perc2}"></td>
									</tr>
									<tr>
										<td class="padding-10" width="40%"><input type="text" name="sub3" class="scored_input form-control" value="{sub3}"></td>
										<td class="padding-10" width="30%"><input type="text" name="score3" class="scored_input form-control" value="{score3}"></td>
										<td class="padding-10" width="30%"><input type="text" name="perc3" class="scored_input form-control" value="{perc3}"></td>
									</tr>
									<tr>
										<td class="padding-10" width="40%"><input type="text" name="sub4" class="scored_input form-control" value="{sub4}"></td>
										<td class="padding-10" width="30%"><input type="text" name="score4" class="scored_input form-control" value="{score4}"></td>
										<td class="padding-10" width="30%"><input type="text" name="perc4" class="scored_input form-control" value="{perc4}"></td>
									</tr>
									<tr>
										<td class="padding-10" width="40%"><input type="text" name="sub5" class="scored_input form-control" value="{sub5}"></td>
										<td class="padding-10" width="30%"><input type="text" name="score5" class="scored_input form-control" value="{score5}"></td>
										<td class="padding-10" width="30%"><input type="text" name="perc5" class="scored_input form-control" value="{perc5}"></td>
									</tr>
									<tr>
										<td class="padding-10" width="40%"><input type="text" name="sub6" class="scored_input form-control" value="{sub6}"></td>
										<td class="padding-10" width="30%"><input type="text" name="score6" class="scored_input form-control" value="{score6}"></td>
										<td class="padding-10" width="30%"><input type="text" name="perc6" class="scored_input form-control" value="{perc6}"></td>
									</tr>
									<tr>
										<td align="right" class="padding-10" width="40%"><span class="m-l-30">Total</span></td>
										<td class="padding-10" width="30%"><input type="text" name="Tscore" class="scored_input form-control" value="{Tscore}"></td>
										<td class="padding-10" width="30%"><input type="text" name="Pscore" class="scored_input form-control" value="{Pscore}"></td>
									</tr>
									<!-- <tr class="border">
						...
						<div class="padding-20">
							...
							<div class="row m-t-16">
								<div class="col-12 col-md-4">
			                        ...
			                        <input type="checkbox" name="twelfth_marks" value="" class="pivileges singleInput form-control" {twelfth_marks} >
			                        <span class="checkmark_enquiry"></span>
			                        </label>
								</div>
								<div class="col-12 col-md-4">
									...
									<label class="checkbox_enquiry" style="top:-30px;">
			                        <input type="checkbox" name="tenth_marks" {tenth_marks} class="pivileges singleInput form-control">
			                        <span class="checkmark_enquiry"></span>
			                        </label>
								</div>
								<div class="col-12 col-md-4">
									...
									<label class="checkbox_enquiry" style="top:-30px;">
			                        <input type="checkbox" name="migration" {migration} class="pivileges singleInput form-control">
			                        <span class="checkmark_enquiry"></span>
			                        </label>
								</div>
								<div class="col-12 col-md-4">
									...
									<label class="checkbox_enquiry" style="top:-30px;">
			                        <input type="checkbox" name="admit_card" {admit_card} class="pivileges singleInput form-control">
			                        <span class="checkmark_enquiry"></span>
			                        </label>
								</div>
								<div class="col-12 col-md-4">
									...
									<label class="checkbox_enquiry" style="top:-30px;">
			                        <input type="checkbox" name="school_leaving" {school_leaving} class="pivileges singleInput form-control">
			                        <span class="checkmark_enquiry"></span>
			                        </label>
								</div>
								<div class="col-12 col-md-4">
									...
									<label class="checkbox_enquiry" style="top:-30px;">
			                        <input type="checkbox" name="photograph" {photograph} class="pivileges singleInput form-control">
			                        <span class="checkmark_enquiry"></span>
			                        </label>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-12">
									<div>
				                        ...
				                        <input type="checkbox" value="" class="pivileges singleInput form-control" required>
				                        <span class="checkmark_enquiry"></span>
				                        </label>
							...
							<div class="row">
								<div class="col-12 col-md-4">
									<div>
										...
										<input type="text" name="submission_date" class="form_input examDate form-control"  data-toggle="datepicker" value="{submission_date}">
									</div>
									<div>
										<label class="fs-14 _blckClr_">Place:</label>
										<input type="text" name="submission_place" class="form_input form-control" value="{submission_place}" >
									</div>
								</div>
								<div class="col-12 col-md-4">
