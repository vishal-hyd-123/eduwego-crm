...
<html>
  <head>
    ...
    <!-- endbuild -->
    <style> .error-message {font-size: 12px;color: red;float: left;z-index:100000;} 
    body{
            padding-bottom: 0;
        }
    .bg_img 
        ...
        <div class="topBottomMargin">
          ...
          <div id="LogIn-Inner" class="row justify-content-center">
            ...
            <div class="col-12 col-lg-6">
              <div class="Login_Ryt">
                <form id="instituteLogin" method="POST" action="<?php echo base_url('admin/login'); ?>">
                  <input type="hidden" name="timezone" id="timeZone">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-11 col-lg-10 text-center Login_Email">
                            <input type="eamil" name="email" placeholder="Email Address" class="Email_Input" required="">
                        </div>
                    </div>
                    <div class="row justify-content-center">
      ...
      <div class="sdssdf">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-4 text-center">
            <p class="copyright_Text">© 2020 EduweGo+ Product of Zeqon Technologies Pvt. Ltd.</p>
          </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="frgt_Padd">
                    ...
                    <form id="resetPassword" method="post" action="<?php echo base_url(); ?>admin/forgot_password">
                      <div class="row justify-content-center">
                        <div class="col-12 col-md-11 col-lg-10 text-center Login_Email">
          ...
          $(':submit').removeAttr('disabled');
             var data = JSON.parse(data);
              ...
              if(data.status == true){
                  ...
                  $( ".error-message" ).remove();
                   setTimeout(function(){
                      window.location.href = '<?php echo base_url(); ?>admin/admin_dashboard';
                   }, 1000); 
              }
            },
            error: function(data){                      
